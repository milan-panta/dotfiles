  ...
  local function draw_menu(menu, x, pos)
    ...
    for index = start_index, end_index, 1 do
      ...
      if is_selected and actions and #actions > 0 and not item.items then
        ...
        actions_rect.bx = actions_rect.is_outside and bg_rect.bx + margin + rect_width or content_rect.bx - margin
    ...
    if draw_title then
      ...
      -- Separator
      ass:rect(rect.ax, rect.by, rect.bx, rect.by + self.separator_size, { color = fg, opacity = menu_opacity * 0.2 })
